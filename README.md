...
编译成功后，生成的轻量级可执行文件位于 dist/ 目录下。
Developed for internal optimization of ZDEM simulation workflows. Please ensure the target directory is correct before purging.